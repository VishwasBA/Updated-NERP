      ...
      <div className="relative z-10 flex h-full flex-col items-center px-16 py-11">
        ...
        <div className="mt-7 flex h-20 w-20 items-center justify-center rounded-full border border-[#A9824C]/40 bg-white">
          <span className="font-serif text-[26px] font-semibold text-[#1C2230]">
            {recognition.toEmployee?.name?.charAt(0) || "E"}
          </span>
        </div>
        ...
        {/* Message */}
        <p className="mt-5 max-w-[600px] text-center text-[13.5px] leading-7 text-[#5B6478]">
          {recognition.message ||
            "In recognition of your outstanding performance, dedication, and valuable contributions to the organization. Your commitment and excellence continue to inspire the entire team."}
        </p>
