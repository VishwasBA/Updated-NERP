      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 flex items-center gap-2.5">
            <UserAvatar name={item.name} size="h-9 w-9" fallbackClassName="text-xs font-bold" />
          ...
          >
            <div className="mt-3 space-y-2.5 border-t border-slate-100 pt-3 dark:border-slate-800">
              {commentsLoading ? (
                ...
                comments.map((c) => (
                  <div key={c.id} className="flex items-start gap-2.5">
                    <UserAvatar name={c.employee.name} size="h-7 w-7" fallbackClassName="text-[10px] font-bold" />
              ...
              <div className="flex items-center gap-2">
                <UserAvatar name={user?.name} size="h-7 w-7" fallbackClassName="text-[10px] font-bold" />
                <input
                  value={commentText}
