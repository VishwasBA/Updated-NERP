...
export default function MyRecognitions() {
  ...
  // Deep-linked from the dashboard's "Latest Milestones" panel's "View
  // All" link, which wants to land straight on the Milestones tab.
  const initialTab = (location.state as { tab?: "awards" | "milestones" } | null)?.tab ?? "awards";
  const [tab, setTab] = useState<"awards" | "milestones">(initialTab);
