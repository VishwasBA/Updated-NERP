...
namespace EmployeeRecognition.API.Migrations
{
    ...
    [Migration("20260513055324_RemovePointsForAppreciation")]
    partial class RemovePointsForAppreciation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NERP.API.Models.AwardCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NERP.API.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Admin User",
                            PasswordHash = "$2a$11$TwxJJY49aK1bCfJx2kqMCOQZsLyv5ZyRFFNiYeTM6MieWPAfCn1HO",
                            Role = "HR Manager",
                            TotalPoints = 0,
                            UserRole = "admin"
                        });
            ...
            modelBuilder.Entity("NERP.API.Models.Recognition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NERP.API.Models.Recognition", b =>
                {
                    b.HasOne("NERP.API.Models.AwardCategory", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("NERP.API.Models.Employee", "FromEmployee")
                        .WithMany("RecognitionsGiven")
                        .HasForeignKey("FromEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("NERP.API.Models.Employee", "ToEmployee")
