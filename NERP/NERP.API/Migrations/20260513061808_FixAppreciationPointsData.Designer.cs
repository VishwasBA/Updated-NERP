...
namespace EmployeeRecognition.API.Migrations
{
    ...
    [Migration("20260513061808_FixAppreciationPointsData")]
    partial class FixAppreciationPointsData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NERP.API.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Admin User",
                            PasswordHash = "$2a$11$5TGIDNUD.ucx7YVbZm6mIuZNFG3MinidsoBXJyeEXwnsBY0L7XMQa",
                            Role = "HR Manager",
                            TotalPoints = 0,
                            UserRole = "admin"
                        });
