...
public class AuthController : ControllerBase
{
    ...
    private static EmployeeDto MapToDto(Employee e) => new()
    {
        ...
        // Not resolved here — this mapper builds from a bare Employee
        // entity without the Manager navigation loaded. Employee Directory
        // / Profile get ManagerName from EmployeesController.GetAll instead.
        ManagerName = null,
        SelfDevelopmentAccumulatedPoints = e.SelfDevelopmentAccumulatedPoints
    };
}
