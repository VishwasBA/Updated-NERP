  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-4">
        {/* Avatar placement */}
        <UserAvatar name={toName} avatar={toAvatar} size="h-12 w-12" fallbackClassName="text-sm font-bold" />
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <div className="flex items-center gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
            <UserAvatar name={fromName || "You"} avatar={fromAvatar} size="h-6 w-6" fallbackClassName="text-[9px]" />
